...
objDropArea0.addEventListener("drop", function (evt) {
    if (judge[0]) {
        ...
        if (obj3) {
            objDropArea0.appendChild(obj3);  //要素を移動する
        }
        evt.preventDefault();
        judge[0] = false
    } else { }
...
objDropArea1.addEventListener("drop", function (evt) {
    if (judge[1]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea1.appendChild(obj3);  //要素を移動する
        }
        judge[1] = false
    } else { }
    console.log(1)
...
objDropArea2.addEventListener("drop", function (evt) {
    ...
    if (judge[2]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea2.appendChild(obj3);  //要素を移動する
        }
        judge[2] = false
    } else { }
    evt.preventDefault();
...
objDropArea3.addEventListener("drop", function (evt) {
    ...
    if (judge[3]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea3.appendChild(obj3);  //要素を移動する
        }
        judge[3] = false
    } else { }
    evt.preventDefault();
...
objDropArea4.addEventListener("drop", function (evt) {
    ...
    if (judge[4]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea4.appendChild(obj3);  //要素を移動する
        }
        judge[4] = false
    } else { }
    evt.preventDefault();
...
objDropArea5.addEventListener("drop", function (evt) {
    ...
    if (judge[5]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea5.appendChild(obj3);  //要素を移動する
        }
        judge[5] = false
    } else { }
    evt.preventDefault();
...
objDropArea6.addEventListener("drop", function (evt) {
    ...
    if (judge[6]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea6.appendChild(obj3);  //要素を移動する
        }
        judge[6] = false
    } else { }
    evt.preventDefault();
...
objDropArea7.addEventListener("drop", function (evt) {
    ...
    if (judge[7]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea7.appendChild(obj3);  //要素を移動する
        }
        judge[7] = false
    } else { }
    evt.preventDefault();
...
objDropArea8.addEventListener("drop", function (evt) {
    ...
    if (judge[8]) {
        ...
        var obj3 = document.getElementById(id);
        if (obj3) {
            objDropArea8.appendChild(obj3);  //要素を移動する
        }
        judge[8] = false
    } else { }
    evt.preventDefault();
